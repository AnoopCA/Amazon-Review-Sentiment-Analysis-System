...
from tensorflow.keras.layers import Input, Embedding, LSTM, Dense, Bidirectional, Attention, Flatten, Dropout
...
# Hyperparameters
MAX_WORDS = 60 #20000  # Vocabulary size
MAX_SEQ_LENGTH = 35 #350  # Maximum sequence length
EMBEDDING_DIM = 32 #128  # Dimension of word embeddings
LSTM_UNITS = 4 #128  # Number of LSTM units
ATTENTION_UNITS = 4 #64  # Dimension of attention mechanism
...
for _ in range(3):  # Add more layers for deeper models
    lstm_output = Bidirectional(LSTM(LSTM_UNITS, return_sequences=True, dropout=DROPOUT_RATE))(lstm_output)
